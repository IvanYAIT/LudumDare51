...
namespace AFPC {
    ...
    public class Lifecycle {
        ...
        /// <summary>
        /// Set maximum health in the start.
        /// </summary>
        ...
        /// </summary>
        public virtual void SetMaximumHealth () {
        ...
        /// </summary>
        public virtual void SetMinimumHealth () {
            health = 1;
        ...
        public virtual void DamageFromRadiation(int radiationLevel)
        {
            if (!isAvailable) return;
            float healthDamage = Mathf.Min(health, radiationDamage);
            health -= healthDamage * 1.5f * radiationLevel;
            if (Mathf.Abs(health) < epsilon)
            {
                Death();
            }
            damageAction?.Invoke();
            if (isDebugLog) Debug.Log(ID + ": Damaged: " + radiationDamage);
        }
